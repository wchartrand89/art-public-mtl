...
?>  
            ...
            <div id="formAdmin">
                ...
                <p id="text_form_admin">AJOUTER UNE OEUVRE</p>
                <form id='inputs_form' action="/art-public-mtl/api/admin/oeuvre/ajouterOeuvre/" method="post">	
                    ...
                    <div class="div_form"> 
                        ...
                        <select class="box" name="materiaux">
                             <?php 
                            foreach($info3 as $key=>$value){
                                $value=array_map('utf8_encode', $value);
                                foreach($value as $val){
                                    if($val==$info["materiaux"]){
                                        echo "<option value='$val' selected>$val</option>";
                                    }else{
                                        echo "<option value='$val'>$val</option>";
                                    }
                    ...
                    <div class="div_form"> 
                        ...
                        <select class="box" name="collection">
                             <?php 
                            foreach($info3 as $key=>$value){
                                $value=array_map('utf8_encode', $value);
                                foreach($value as $val){
                                    if($val==$info["collection"]){
                                        echo "<option value='$val' selected>$val</option>";
                                    }else{
                                        echo "<option value='$val'>$val</option>";
                                    }
                    ...
                    <div class="div_form"> 
                        ...
                        <select class="box" name="technique">
                             <?php 
                            foreach($info3 as $key=>$value){
                                $value=array_map('utf8_encode', $value);
                                foreach($value as $val){
                                    if($val==$info["technique"]){
                                        echo "<option value='$val' selected>$val</option>";
                                    }else{
                                        echo "<option value='$val'>$val</option>";
                                    }
                    ...
                    <div class="div_form">
                        <label for="titre">Adresse Civique</label>
                        <input class="box" type="text" name="adresseCivique" value="" id="AdresseCivique">
                    </div>
                    <div class="div_form">
                        <label for="titre">Latitude</label>
                        <input class="box" type="text" name="latitude" value="" id="latitude">
                    </div>
                    <div class="div_form">
                        <label for="titre">Longitude</label>
                        <input class="box" type="text" name="longitude" value="" id="longitude">
                    </div>  
                    <div class="div_form">
